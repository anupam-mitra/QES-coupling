...
from functions import gFunc, fFunc, trPiece1, trPiece2, normbNeg00, rhoPreFacs
...
if __name__ == '__main__':
    ...
    for i in range(0, 141):
        ...
        b2idpiov4 = -(i + 1) * 0.25
        print("Begin analysis for b = %g" % (b2idpiov4))
        ...
        if b2idpiov4 < 0:
            a4 = normbNeg00(a2idpiov4, b2idpiov4)**(4.0)
        elif b2idpiov4 > 0:
            pass
        elif b2idpiov4 == 0:
            pass
        ...
        print("Probability double-check for b = %g" % (b2idpiov4))
        print("that trace rho reduced == 1")
        print("trRhoRedPiece1 = %g +- %g" % (trRhoRedPiece1Est, trRhoRedPiece1Err))
        print("trRhoRedPiece2 = %g +- %g" % (trRhoRedPiece2Est, trRhoRedPiece2Err))
        print("trRhoRed = %g +- %g" % (trRhoRedEst, trRhoRedErr))
        ...
        print("Purity for b = %g" % (b2idpiov4))
        print("purityPiece1 = %g +- %g" % (purityPiece1Est, purityPiece1Err))
        print("purityPiece2 = %g +- %g" % (purityPiece2Est, purityPiece2Err))
        print("purity = %g +- %g" % (purityEst, purityErr))
